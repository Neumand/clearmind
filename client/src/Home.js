          ...
          <Col>
            <Media>
              ...
              <Media.Body>
                ...
                <p>
                  Keep track of your sessions with SMS confirmations, and cancel
                  an upcoming appointment with the click of a button.
                </p>
              </Media.Body>
            </Media>
          </Col>
        ...
        <Row>
          <Col className='vector-column' style={{ textAlign: `right` }}>
            ...
            <p>
              ...
              stigma surrounding it and remind those suffering that they are not
              alone. Learn more about how you can help or hear from inspiring
              individuals by browsing our articles.
            </p>
            <Link to='/resources'>
